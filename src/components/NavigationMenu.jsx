import { MenuClose, MenuOpen } from '../utils/MenuToggle';
    ...
    return (
        <nav className="p-4">
            <div className="flex justify-between items-center">
                ...
                <button
                    type="button"
                    onClick={MenuOpen} // Pass the function reference, do not call it here
                    id="menu-btn"
                    className="bg-no-repeat bg-cover p-4"
                ></button>
                <button
                    type="button"
                    onClick={MenuClose} // Pass the function reference, do not call it here
                    id="close-btn"
                    className="bg-no-repeat bg-cover p-4 hidden"
                ></button>
            </div>
